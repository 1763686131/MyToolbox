...
class CloudToolDialog(ctk.CTkToplevel):
    ...
    """万能三级弹窗：只要传入文件名，自动处理所有本地/云端逻辑"""

    def __init__(self, master, display_name, exe_name, *args, **kwargs):
    ...
    def _download_task(self):
        # 🌟 重点在这里：直接从公共 config 获取下载链接！
        download_url = config.get_api_download_url(self.tool_name)
